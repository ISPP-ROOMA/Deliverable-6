...
### 2.1 Nuevos Casos de Uso (Entregable PPL)

*(En este caso no se ha realizado ningún caso de uso desde 0, solo se han realizado pequeñas extensiones ya que los teníamos completados en su mayoría)*

#### CU: Descubrimiento de viviendas --> Se ha añadido la funcionalidad de filtrado de inmuebles por su precio mínimo, máximo y ubicación
